...
public class test_3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("does accept 'aab'?");
        System.out.println(my_nfa.doesAcceptString("aab")); // true

        System.out.println("does accept 'aa'?");
        System.out.println(my_nfa.doesAcceptString("aa")); // false

        System.out.println("does accept 'aaa'?");
        System.out.println(my_nfa.doesAcceptString("aaa")); // true

        System.out.println("does accept 'aaaa'?");
        System.out.println(my_nfa.doesAcceptString("aaaa")); // false

        System.out.println("does accept 'baa'?");
        System.out.println(my_nfa.doesAcceptString("baa")); // false
    }
}
